...
class HogFeature(AbstractFeature):
    ...
    def __init__(self,orientations=8,pixels_per_cell=(10,10),cells_per_block=(1,1)):
    ...
    def process(self,im):
        ...
        fd = hog(greyscaled, orientations=self.orientations, pixels_per_cell=self.pixels_per_cell, cells_per_block=self.cells_per_block, visualise=False)
        return fd
