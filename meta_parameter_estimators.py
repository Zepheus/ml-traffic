...
def estimate_metas(directories, trainer):
    meta_estimators = [ estimate_hog_resize_parameters,
                        estimate_hog_orientations_parameters,
                        estimate_hog_cells_per_block_parameters,
                        estimate_detect_circle_parameters,
                        estimate_detect_symmetry_small_block_parameters,
                        estimate_detect_symmetry_large_block_parameters,
                        estimate_detect_symmetry_small_block_parameters,
                        estimate_hog_pixels_per_cell_parameters
                       ]
